   ...
   <hr>
    <div class="row">
      ...
      <div class="col-lg-3 mb-4">
        ...
        <div class="row">
          <div class="col-md-12">
            <img src="{{site.url}}{{ site.baseurl}}/static_files/people/adult-men.jpeg" alt="wrapkit" class="img-fluid rounded-circle" />
          </div>
          <div class="col-md-12 text-center">
            <div class="pt-2">
...
<div class="row">
      ...
      <div class="col-lg-3 mb-4">
        ...
        <div class="row">
          ...
          <div class="col-md-12 text-center">
            <div class="pt-2">
              <h5 class="mt-4 font-weight-medium mb-0">Hitomi Kano</h5>
              <h6 class="subtitle mb-3">spiker ltd</h6>
            </div>
          </div>
        </div>
        <!-- Row -->
