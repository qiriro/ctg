...
<figure class="figure">
  <img src="{{site.baseurl}}{{static_files/images/alert-screenshoot.png}}" class="figure-img img-fluid rounded" alt="A generic square placeholder image with rounded corners in a figure.">
